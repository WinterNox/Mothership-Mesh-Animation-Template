...
function mothership.new(x, y)
  ...
  pewpew.entity_set_update_callback(entity_id, function()
    ...
    pewpew.customizable_entity_set_flipping_meshes(entity_id, "/dynamic/Mothership/graphics.lua", frame % total_frames, (frame + 1) % total_frames)
  end)
